...
IniRead, waifuCounter, variables.ini, waifubot, waifuCount
IniRead, PAUSE_TIMER, variables.ini, waifubot, pauseTimer
...
~^F4::
  ...
  GuiControl, Text, statusToggle, Current Status: Stopping
  While exitScript = false{
    IniRead, exitScript, variables.ini, waifubot, exitScript
  }
  MsgBox, test
return
